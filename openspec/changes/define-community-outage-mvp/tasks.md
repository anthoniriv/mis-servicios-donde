...
- [x] 5.2 Add E2E report-to-map/outbox, retry, concurrency, disabled-feature, and public-privacy flows.
- [x] 5.3 Document setup, gates, secrets, workers, rollout, and rollback in `README.md`; run every CI check.
